...
quiz(
question_text("In two sentences, what makes a Preceptor Table ideal, and why is this generally impossible to observe? (You should use the phrase 'potential outcomes' in yuour answer)",
    allow_retry = F,
    answer(NULL, correct = T),
    trim = F,
    incorrect = "Ok"
